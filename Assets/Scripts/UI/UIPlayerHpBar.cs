...
{
    [SerializeField] private float _gap = 1.0f; // 대상기준 거리
    [SerializeField] private Image _imgHpBar;
    [SerializeField] private Player _player; // 따라갈 대상
    
    private Camera _camera; // 따라갈 카메라
    private Vector3 _gapPos; // 얼마큼 떨어트릴지
